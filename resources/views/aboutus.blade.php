                  ...
                  <div class="row py-4 py-md-5 py-lg-5 gx-1 justify-content-center align-items-center">
                      ...
                      <div class="col-md-11 col-lg-7 col-xl-7 py-3 pt-md-4 pb-md-0 py-lg-0">
                          ...
                          <div class="text mt-1 mt-md-3 px-0 px-md-2 px-lg-5">
                              <p>
                                  Sun Myat Tun, popularly known as SMT, was established by Dr..
                                  Nay Lin Tun in 2009. SMT mainly focus on started building
                              ...
                              <p>
                                  ...
                                  providing thousands of homes to local people within seven years
                                  from 2013 up to 2020. SMT successfully handled many Turnkey
              ...
              <div class="container px-0 overflow-hidden">
                <section class="achievement-awards ">
                    <div class="row py-3 px-2 px-md-5 pb-md-5 ">
                        <div class="col-12">
                          <h3 class="text-center fw-bold mb-3 mb-md-5 title">ACHIEVEMENT & AWARDS</h3>
                        </div>
