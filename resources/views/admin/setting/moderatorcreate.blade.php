...
<head>
    ...
    <title>Moderator Create - SMT</title>
                    ...
                    <div class="bg-secondary bg-opacity-50 px-2 py-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0">
                                <li class="breadcrumb-item"><a href="../setting/setting.html">Setting</a></li>
                        ...
                        <div class="py-3 px-3">
                            <div class="row create">
                                ...
                                <div class="col-12 col-md-12 col-lg-12 ">
                                    <form action="{{ route('setting.store') }}" method="POST" enctype="multipart/form-data" class="create-form moderator-form">
                                    @csrf
                                        <div class="row gx-1 d-flex flex-column flex-lg-row justify-content-center align-items-start mx-auto py-5">
                                            <div class="col-12 col-md-4 col-lg-4 col-xl-3 d-flex justify-content-center align-items-center justify-content-lg-start">
                                                <div class="user-img-div d-flex justify-content-center align-items-center rounded-circle border border-primary overflow-hidden " >
                                                    <input type="file" name="image" class="form-control d-none @error('image') is-invalid @enderror" id="user_input" value="{{old('image')}}">
                                                    <img src="../../images/gold.jpg" id="user-img" alt="" >
                                                    ...
                                                    <div class="row row-cols-1 row-cols-lg-2">
                                                        <div class="col">
                                                            <div class="mb-3">
                                                                ...
                                                                <input id="userName" name="name" type="text" class="create-input form-control @error('name') is-invalid @enderror form-control-lg rounded rounded-1  text-dark mb-2 mb-md-0 fs-6" placeholder="name" value="{{old('name')}}">
                                                                @error('name')
                                                        ...
                                                        <div class="col">
                                                            <div class="mb-3">
                                                                ...
                                                                <input id="role" name="role" type="text" class="create-input form-control @error('role') is-invalid @enderror form-control-lg rounded rounded-1  text-dark mb-2 mb-md-0 fs-6" placeholder="role" value="{{old('role')}}">
                                                                @error('role')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                        ...
                                                        <div class="col">
                                                            <div class="mb-3">
                                                                ...
                                                                <input id="email" name="email" type="email" class="create-input form-control @error('email') is-invalid @enderror form-control-lg rounded rounded-1  text-dark mb-2 mb-md-0 fs-6" placeholder="email" value="{{ old('email') }}" required autocomplete="email">
                                                                @error('email')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                        ...
                                                        <div class="col">
                                                            <div class="mb-3">
                                                                ...
                                                                <input id="phone" name="phone" type="number" class="create-input form-control @error('phone') is-invalid @enderror form-control-lg rounded rounded-1  text-dark mb-2 mb-md-0 fs-6" placeholder="phone" value="{{old('phone')}}">
                                                                @error('phone')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                        ...
                                                        <div class="col">
                                                            <div class="mb-3">
                                                                ...
                                                                <input id="password" name="password" type="password" class="create-input form-control  @error('password') is-invalid @enderror form-control-lg rounded rounded-1  text-dark mb-2 mb-md-0 fs-6" placeholder="password" required>
                                                                @error('password')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                        ...
                                                        <div class="col">
                                                            <div class="mb-3">
                                                                ...
                                                                <input id="confirmPassword" name="password_confirmation" required autocomplete="new-password" value="" type="password" class="create-input form-control @error('password') is-invalid @enderror form-control-lg rounded rounded-1  text-dark mb-2 mb-md-0 fs-6" placeholder="confirmPassword" autocomplete="current-password" required>
                                                            </div>
                                                        </div>
